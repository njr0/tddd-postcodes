---
title: "UK Postcodes matching a Reasonable Regex"
format:
  html:
    code-fold: true
jupyter: python3
...
```{python}
from letters import nL         # number of letters in alphabet
...
`{python} n_formatted` postcode-like strings match the regular expression:
